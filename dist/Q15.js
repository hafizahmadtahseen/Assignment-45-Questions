...
// else to invite.• Start with your program from Exercise 14. Add a print statement at the end of your
...
let guests = ["Ahmad", "Ali", "Umer", "Farhan"];
console.log("Sorry " + guests[2] + "!" + " You are not able to come at dinner");
guests.splice(2, 1, "Munna");
guests.forEach((i) => {
