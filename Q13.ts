...
// let fvrttransport: Array<[transport: string, brand: string]> = [];
// fvrttransport.push(["car", "Toyota"]);
// fvrttransport.push(["Bike", "Yamaha"]);
// fvrttransport.forEach(([transport,brand]))=>
// console.log(`I like to have ${i} ${}`);
